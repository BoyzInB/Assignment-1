 ...
 *******************************************************************
 ...
 Input      : Read files (Mpi_Matrix_Data1) for  first input matrix
 and (Mpi_Matrix_Data2) for second input matrix.
...
main (int argc, char *argv[])
{
    ...
    /* Reading Input */
    if (grid.MyRank == Root){
        if ((fp = fopen ("./Data/Mpi_Matrix_Data1", "r")) == NULL){
        ...
        if((fp = fopen ("./Data/Mpi_Matrix_Data2", "r")) == NULL){
