...
// Size of virtual processor grid
31
int GridCoords[2];
MPI_Comm GridComm;
MPI_Comm ColComm;
MPI_Comm RowComm;
// Coordinates of current processor in grid
// Grid communicator
// Column communicator
// Row communicator
...
// Function for creating the two-dimensional grid communicator // and communicators for each row and each column of the grid void CreateGridCommunicators() {
...
// Scatter the matrix among the processes of the first grid column CheckerboardMatrixScatter(pAMatrix, pMatrixAblock, Size, BlockSize); CheckerboardMatrixScatter(pBMatrix, pBblock, Size, BlockSize);
}
...
// Function for cyclic shifting the blocks of the matrix B void BblockCommunication (double *pBblock, int BlockSize) {
MPI_Status Status;
...
double* pAMatrix; // First argument of matrix multiplication double* pBMatrix; // Second argument of matrix multiplication double* pCMatrix; // Result matrix
int Size;
int BlockSize;
double *pAblock;
double *pBblock;
...
// Size of matrices
// Sizes of matrix blocks
// Initial block of matrix A
// Initial block of matrix B
// Block of result matrix C
...
// Memory allocation and initialization of matrix elements ProcessInitialization ( pAMatrix, pBMatrix, pCMatrix, pAblock, pBblock,
